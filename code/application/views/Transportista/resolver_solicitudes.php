	                ...
	                <div class="col-md-12">
	                    <div class="panel panel-filled">
	                        ...
	                        <div class="panel-body">
								...
								<div class="table-responsive" style="margin-bottom:30px;">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody style="font-size: 13px !important;">
                                        	...
                                        	<?php 
			                            	if($modalidad == "oferta") { // MI OFERTA A SOLICITAR
                                ...
                                <?php
		                    		if($modalidad == "oferta") {
										$txtOp = "Selecciona tu oferta con la que postulas a esta carga:";
		                            }else{   	
		                              	$txtOp = "Selecciona la carga que desees transportar:";
		                        } ?>

                                <h3 style="text-transform: uppercase; font-size: 14px; font-family: 'couturebold'" class="m-b-xs"><?= $txtOp ?></h3>
								<div class="table-responsive">
                                	...
                                	<button class="btn btn-default btn-sm destacado-btn btn-right" style="color: #ffffff; border-color: #f7af3e; background-color: #f7af3e; font-weight:bold">
										<?= $txtSubmit; ?>
									</button>
