                    ...
                    <div class="col-lg-10">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                ...
                                <small>Mis solicitudes enviadas para <strong>cargar</strong>, en estado pendiente.</small>
                            </div>
                        </div>
                    </div>
	                ...
	                <div class="col-md-12">
	                    <div class="panel panel-filled">
	                        <div class="panel-heading">
	                            ...
	                            Tabla de Registros de tus Solicitudes
	                        </div>
	                        <div class="panel-body">
											...
											<?php
												...
												if(isset($missolicitudes) && $missolicitudes!= false){		
													...
													foreach($missolicitudes as $s => $v){	
														...
														//echo  '<td><i class="fa fa-calendar" aria-hidden="true"></i> '.$v["fecha_publicacion"].'</td>';
