					...
					<div class="col-md-7">
	                    <div class="panel panel-filled">
	                        <div class="panel-body">
				                ...
				                <?php
									$usr = $this->session->userdata('login_type');
									$uri1 = "?".$usr."/ofrecercamion_editar/upd";
									echo form_open($uri1);
								?>
				                <div class="col-md-6" style="padding-left: 0;">
				                	...
				                	echo '<option value="-1">Seleccione Patente</option>';
				                		if(isset($camiones)){
						                    foreach($camiones as $s => $v):                      
						                        ...
						                        if($oferta[0]["patente"] == $v["patente"]) echo 'selected';
						                        echo '>';
						                        echo $v["patente"];
						                        echo '</option>';
						                    endforeach;
				                	...
				                	echo '<div class="form-group">';
									echo '<label for="exampleInputEmail1">Ubicación Actual</label>';
									...
									echo '<option value="-1">Seleccione Ubicación</option>';
			                            if(isset($ciudades)){
				                             foreach($ciudades as $s => $v):                      
				                                ...
				                                if($oferta[0]["ubicacion"] == $v["idciudad"]) echo 'selected';
				                                echo '>';
				                                echo $v["nombre"];
				                                echo '</option>';
				                            endforeach;
									...
									echo '<option value="-1">Seleccione Destino</option>';
			                            if(isset($ciudades)){
				                             foreach($ciudades as $s => $v):                      
				                                echo '<option value="'.$v["idciudad"].'" cod="'.$v["idregion_fk"].'"';
				                                if($oferta[0]["destino_preferente"] == $v["idciudad"]) echo 'selected';
				                                echo '>';
				                                echo $v["nombre"];
				                                echo '</option>';
					            ...
					            echo '<div class="col-md-6">';
									...
									echo '<input name="fecha_disponibilidad" value="';
									if (isset($oferta)) echo $oferta[0]["fecha_disponibilidad"];
									echo '" data-parsley-required="true" class="form-control" placeholder="YYYY/MM/DD" type="text">';
									echo '</div>';
									echo '<div class="form-group">&nbsp;';
									echo '</div>';
									echo '<div class="form-group">';
									echo '<label for="exampleInputEmail1">Dirección Específica Actual</label>';
									echo '<input name="direccion_ubicacion" value="';
									if (isset($oferta)) echo $oferta[0]["direccion_ubicacion"];
									echo '" data-parsley-required="true" class="form-control" type="text"/>';
									echo '</div>';
									echo '<div class="form-group">&nbsp;';
									echo '</div>';
									echo '<div class="form-group">';
									echo '<label for="exampleInputEmail1">Dirección Específica de Destino</label>';
									echo '<input name="direccion_destino" value="';
									if (isset($oferta)) echo $oferta[0]["direccion_destino"];
									echo '" data-parsley-required="true" class="form-control" type="text"/>';
									echo '</div>';
								echo '</div>';
