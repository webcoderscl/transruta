                    ...
                    <div class="col-lg-10">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3 class="m-b-xs">Solicitudes enviadas</h3>
                                <small>Mis solicitudes enviadas para <b>transportar</b> en proceso.</small>
                            </div>
                        </div>
                    </div>
											...
											<?php
												...
												if(isset($missolicitudes) && $missolicitudes!= false){		
													...
													foreach($missolicitudes as $s => $v){	
														...
														$uridel = "?".$usr."/misofertas_editar/del/".$id;
														$urijoin = "?".$usr."/resolver_solicitudes/show/0/".$id;
														$uridet = "?".$usr."/missolicitudesenviadas/detalle/".$id;
														...
														echo  '<td> $'.$prc.'</td>';
														echo  '<td style="width: 150px; text-align:center;"><span class="badge slct" style="width:100%;"><i class="fa fa-circle-o-notch fa-spin" aria-hidden="true"></i> ';
														...
														if(intval($v["estado"]) == 2){
															...
															echo '<a type="button" href="#" onClick=deleteRow("'.$uridel.'")  data-toggle="modal" data-target="#myModalRemove" class="btn btn-danger inline-block" style="width:100%"><i class="fa fa-times-circle-o" aria-hidden="true"></i> Cancelar</a>';
														}	
															echo '</div>';						
														echo '</td>';
														echo '</tr>';
