	                ...
	                <div class="col-md-5">
	                    <div class="panel panel-filled">
	                        <div class="panel-body">
				                ...
				                <p>
				                    Rellene los datos para que publique su oferta de carga, así podrán verla todos los transportistas que estén buscando carga.
				                </p>
				                <?php
									$usr = $this->session->userdata('login_type');
								...
								<?php
	                                ...
	                                */
	                                ...
	                                echo '<div class="form-group">';
									echo '<label for="exampleInputEmail1">Correo Contacto</label>';
