                    ...
                    <div class="col-lg-12">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                ...
                                <small>Bienvenido Administrador, comienza aquí.</small>
                            </div>
                        </div>
                        <hr>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-2 col-xs-6">
                        <div class="panel panel-filled">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="slight m-t-sm"><i class="fa fa-clock-o"> </i> Reciente: <span class="c-white">0 Nuevos</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-xs-6">
                        <div class="panel panel-filled">
                            <div class="panel-body">
                                <h2 class="m-b-none">
                                    <span class="pe-7s-like2"></span> <?php if(isset($num_cargas_disp)) echo " ".$num_cargas; ?>  <span class="slight"><i class="fa fa-play fa-rotate-270 text-warning"> </i></span>
                                </h2>
                    ...
                    <div class="col-lg-2 col-xs-6">
                        <div class="panel panel-filled">
                            <div class="panel-body">
                                <h2 class="m-b-none">
                                    <span class="pe-7s-target"></span> <?php if(isset($num_transportes_disp)) echo " ".$num_transportes_disp; ?> <span class="slight"><i class="fa fa-play fa-rotate-270 text-warning"> </i> </span>
                                </h2>
