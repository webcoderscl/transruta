                    ...
                    <div class="col-lg-10">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3 class="m-b-xs">Lista de Choferes</h3>
                                <small>Listado de Choferes Registrados en el Sistema.</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2">
						...
						<button onClick=modalChange('<?php echo site_url().$uriadd ?>',nameform,title_add,title_text_add) class="btn btn-default btn-sm destacado-btn btn-right" data-toggle="modal" data-target="#myModal">
							<i class="fa fa-plus" aria-hidden="true"></i> Agregar Nuevo Chofer
						</button>
						-->
