...
$autoload['model'] = array('Email_model' , 'Generic_model', 'Crud_model','Transportista_model','Generadorcarga_model',
						   'Engine_model','Empresa_model','Camionero_model','Account_model');
